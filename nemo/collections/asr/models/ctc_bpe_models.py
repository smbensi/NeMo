...
from nemo.collections.asr.parts.mixins import ASRBPEMixin, ASRAGGBPEMixin
from nemo.collections.asr.parts.preprocessing.perturb import process_augmentations
from nemo.core.classes.common import PretrainedModelInfo
from nemo.utils import logging, model_utils

__all__ = ["EncDecCTCModelBPE", "EncDecCTCMultiModelBPE"]
...
class EncDecCTCMultiModelBPE(EncDecCTCModel, ASRAGGBPEMixin):
    """Encoder decoder CTC-based multilingual models with Byte Pair Encoding."""
    ...
    def __init__(self, cfg: DictConfig, trainer=None):
        ...
        if self.tokenizer is not None:
            ...
            # Set the new vocabulary
            with open_dict(cfg):
                cfg.labels = ListConfig(vocabulary)
    ...
    def change_tokenizer(
        self, new_tokenizer_cfg: DictConfig, decoding_cfg: Optional[DictConfig] = None
    ):
        """
        Changes vocabulary of the tokenizer used during CTC decoding process.
        Use this method when fine-tuning on from pre-trained model.
